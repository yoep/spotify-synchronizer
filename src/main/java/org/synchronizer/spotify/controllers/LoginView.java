...
public class LoginView extends ScaleAwareImpl implements Initializable {
    ...
    private void verifyIfRedirectIsCallback(String url) {
        ...
        if (url.contains(configuration.getEndpoints().getRedirect().toString())) {
            ...
            setWindowSize(new Rectangle(800 * scaleFactor, 550 * scaleFactor));
        } else {
            setWindowSize(new Rectangle(600 * scaleFactor, 750 * scaleFactor));
        }
    }
