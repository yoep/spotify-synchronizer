...
import org.synchronizer.spotify.controllers.model.AlbumTrackListenerImpl;
...
public class AlbumOverviewComponent extends AbstractPlaybackStateComponent implements Initializable {
    ...
    public AlbumOverviewComponent(AlbumOverview albumOverview) {
        ...
        this.text = SpotifySynchronizer.APPLICATION_CONTEXT.getBean(LocaleText.class);
    }
    ...
    private void initializeAlbumOverlay() {
        ...
        ContextMenu contextMenu = new ContextMenu(UIUtils.createMenuItem(text.get(SyncMessage.SYNC_ALL), Icons.REFRESH, this::syncAllTracks));
